...
const name = "xiangling";
const image = "./Xiangling/images/xiangling.png";

///////////////////////////////////////////////////////////////////////

/****** CHARACTER MATERIAL VARIABLES *******/
const stones = ["agnidusagatesliver", "agnidusagatefragment", "agnidusagatechunk", "agnidusagategemstone", "jueyunchili"];
...
const builds = [
    {
        title: "Pyro Support", 
        description: "Xiangling is one of the strongest Sub DPS characters in the game if played in a Melt composition thanks to the scaling and power of her Elemental Burst.",
        mainweapon: "skywardspine", 
        replaceweapon: "prototypestarglitter", 
        artifactset1: ["crimsonwitchofflames"], 
        artifactset2: ["emblemofseveredfate"],
        substats: "ATK% / Pyro DMG / CRIT DMG"
    },
    {
        title: "Pyro DPS", 
        description: "Xiangling has found new strength with new weapons and artifact sets released in content updates that make her a formidable Main DPS Pyro character.",
        mainweapon: "thecatch", 
        replaceweapon: "staffofhoma", 
