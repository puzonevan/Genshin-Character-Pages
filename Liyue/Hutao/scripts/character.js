...
const name = "hutao";
const image = "./Hutao/images/hutao.png";

///////////////////////////////////////////////////////////////////////

/****** CHARACTER MATERIAL VARIABLES *******/
const stones = ["agnidusagatesliver", "agnidusagatefragment", "agnidusagatechunk", "agnidusagategemstone", "silkflower"];
...
const builds = [
    {
        title: "Pyro DPS 2", 
        description: "Hu Tao excels at single target damage, especially when animation cancelling her Charged Attack and triggering Melt and Vaporize. Pairing Hu Tao with shields to keep her below 50% HP is very powerful.",
        mainweapon: "primordialjadewingedspear", 
        replaceweapon: "deathmatch", 
        artifactset1: ["crimsonwitchofflames"], 
        artifactset2: ["shimenawasreminiscence"],
        substats: "HP% / Pyro DMG / CRIT RATE"
    },
    {
        title: "Pyro DPS", 
        description: "Hu Tao excels at single target damage, especially when animation cancelling her Charged Attack and triggering Melt and Vaporize. Pairing Hu Tao with shields to keep her below 50% HP is very powerful.",
