...
const stones = ["vajradaamethystsliver", "vajradaamethystfragment", "vajradaamethystchunk", "vajradaamethystgemstone", "corlapis"];
const stoneAmounts = [1, 9, 9, 6, 168];
const collectable = ["whopperflowernectar", "shimmeringnectar", "energynectar"];
...
const builds = [
    {
        title: "Physical DPS Build", 
        description: "This build focuses on empowering Keqing's best and most reliable source of damage, her physical charged attacks.",
        mainweapon: "primordialjadecutter", 
        replaceweapon: "prototyperancour", 
        artifactset1: ["bloodstainedchivalry", "gladiatorsfinale"], 
        artifactset2: ["gladiatorsfinale", "shimenawasreminiscence"],
        substats: "ATK% / Electro DMG / CRIT DMG"
    },
    {
        title: "Electro DPS", 
        description: "Keqing has the highest single target charged attack DPS in the game. This build turns Keqing into a crit machine, taking advantage of the boost to CRIT DMG she gets with every ascension level.",
        mainweapon: "primordialjadecutter", 
        replaceweapon: "theblacksword", 
        artifactset1: ["gladiatorsfinale", "thunderingfury"], 
        artifactset2: ["thundersoother"],
        substats: "ATK% / Electro DMG / CRIT DMG"
    },
]
